...
let self = liberator.plugins.smooziee = (function(){
  ...
  var PUBLICS = {
    smoothScrollBy: function(moment) {
      ...
      interval = window.eval(liberator.globalVariables.smooziee_scroll_interval || '5');
  ...
  function getScrollAmount() window.eval(liberator.globalVariables.smooziee_scroll_amount || '100');
